public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(recursiveBinarySearch(data, 916, 0, data.length-1));
    }
    ...
    public static int recursiveBinarySearch(int[] arr, int n, int upper, int lower) {
        ...
        if (arr[midpoint] > n) {
            ...
            return recursiveBinarySearch(arr, n, 0, midpoint);
        } else if (arr[midpoint] < n) {
            System.out.println("higher, " + arr[midpoint]);
            return recursiveBinarySearch(arr, n, midpoint, arr.length-1);
        }
        return -1;
    }
}
